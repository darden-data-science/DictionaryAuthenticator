...
version_ns = {}
with open(pjoin(here, 'DictionaryAuthenticator', '_version.py')) as f:
    exec(f.read(), {}, version_ns)


setup_args = dict(
    name                = 'DictionaryAuthenticator',
    packages            = ['DictionaryAuthenticator'],
    version             = version_ns['__version__'],
    description         = "DictionaryAuthenticator: Authenticator that checks passwords against a plaintext dictionary.",
    ...
    entry_points={
        'jupyterhub.authenticators': [
            'dictionary_authenticator = DictionaryAuthenticator:DictionaryAuthenticator',
        ],
    },
    classifiers         = [
